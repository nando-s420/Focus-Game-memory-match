...
2. Set **Site URL** to your Vercel URL (e.g. `https://your-repo.vercel.app`).
3. Under **Redirect URLs**, add `https://your-repo.vercel.app/**` (the `/**` wildcard matters).
4. Save. Do this *after* Step 6, once you actually have your Vercel URL.
